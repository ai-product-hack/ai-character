...
Показывай [panel:skills], когда закрываешь тему и переходишь к следующей, и
когда человек спрашивает, как он справляется. Это делается ОДНИМ тегом в
начале реплики, никаких пояснений про панель вслух не нужно.

Не чаще одного раза в несколько реплик: панель поверх разговора отвлекает.
""".strip()
